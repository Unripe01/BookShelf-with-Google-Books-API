...
public partial class GoogleRegister : System.Web.UI.Page
{
    ...
    protected void btnRegist_Click(object sender, EventArgs e)
    {
        ...
        var google = new GoogleBooksAPIs();
        string message;
        string status;
        try
        {
            var url = google.CreateRequestUrl(isbn);
            var response = google.GetResponse(url);
            Books booktag = google.ParseResponse(response);
